...
const Column = ({ id, title, tasks = [] }) => {
  ...
  return (
    <div className="bg-lines-light py-3shadow flex w-72 shrink-0 flex-col self-start rounded-lg px-4">
      {isEditMode ? (
        <textarea className="text-heading-m outline-light-grey h-full resize-none"></textarea>
      ) : (
        <button
