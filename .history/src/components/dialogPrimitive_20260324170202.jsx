...
const DialogPrimitive = ({
  ...
  <Dialog.Root open={isOpen} onOpenChange={setOpen}>
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-1/2 left-1/2 max-h-[85vh] w-[90vw] max-w-125 -translate-x-1/2 -translate-y-1/2 rounded-md bg-black p-6.25 shadow-(--shadow-6) focus:outline-none">
