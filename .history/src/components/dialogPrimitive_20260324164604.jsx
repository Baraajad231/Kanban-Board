...
const DialogPrimitive = () => (
  <Dialog.Root>
    <Dialog.Trigger asChild>
      <button className="bg-violet4 text-violet11 hover:bg-mauve3 focus-visible:outline-violet6 inline-flex h-8.75 items-center justify-center rounded px-3.75 leading-none font-medium outline-offset-1 outline-none select-none focus-visible:outline-2">
        Edit profile
      </button>
    </Dialog.Trigger>
    <Dialog.Portal>
