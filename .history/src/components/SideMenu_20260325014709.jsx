      ...
      <ul>
        {DATA.map((item, index) => (
          <li key={item.id}>
            <button
              className={clsx(
                "text-heading-m text-medium-grey data-[isactive=false]:hover:bg-main-purple/10 hover:bg-main-purple/10 data-[isactive=false]:hover:text-main-purple flex w-11/12 items-center gap-4 rounded-e-full px-8 py-4 transition",
                {
          ...
          <DialogPrimitive
            ...
            triggerComponent={() => (
              <button
                ...
                className="text-main-purple flex w-full items-center gap-4 px-8 py-4"
              >
