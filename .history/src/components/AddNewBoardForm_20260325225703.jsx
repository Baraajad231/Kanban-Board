...
const AddNewBoardForm = ({ boardId }) => {
  ...
  const { setSelectedBoardIndex, setDataState } = useContext(DataContext);
  ...
  const creatNewColumnArray = (columnsArray, formData) =>
  ...
  const updateBoardData = (boardName, newColumnArray, setDataState, boardId) => {
    setDataState((prev) => {
      return [
        ...prev,
        {
  ...
  const handleFormSubmit = (e) => {
    ...
    const newColumnArray = creatNewColumnArray(columnsArray, formData);
    updateBoardData(boardName, newColumnArray, setDataState, boardId);
  };
